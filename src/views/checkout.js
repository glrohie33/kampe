        ...
        <section className={'row checkout cart-view'}>
            <div className={'col flex flex-wrap'}>
                ...
                <div className={'col_4 side-bar'}>
                    ...
                    <div className="card">
                        <div className={'title'}>Select Payback Duration</div>
                        <div className="content">
                            <select  onChange={setData} name={'subscriptionPeriod'} className={'input form-control'} defaultValue={form.subscriptionPeriod}>
                                {
